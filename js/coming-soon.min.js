...
function add_other() {
    ...
    if (x.checked) {
        $('#other_item').addClass("border-icons");
    }
    else {
        $('#other_item').removeClass("border-icons");
    }
}
function add_metall() {
...
function subscribe() {
    ...
    if (!surname || !name || !email) {
        ...
        if (pattern.test(surname) && pattern.test(name) && pattern_mail.test(email)) {
            ...
            $('#answer').text("Перевірьте правильність вводу прізвища");
